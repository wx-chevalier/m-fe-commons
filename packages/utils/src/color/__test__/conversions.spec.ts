...
describe('TinyColor Conversions', () => {
  ...
  it('HSL Object', () => {
    for (const c of conversions) {
      const tiny = new TinyColor(c.hex);
      expect(tiny.toHexString()).toBe(
        new TinyColor(tiny.toHsl()).toHexString(),
      );
    }
  });
  it('HSL String', () => {
  ...
  it('HSV Object', () => {
    for (const c of conversions) {
      ...
      expect(tiny.toHexString()).toBe(
        new TinyColor(tiny.toHsv()).toHexString(),
      );
    }
  });
  ...
  it('RGB Object', () => {
    for (const c of conversions) {
      const tiny = new TinyColor(c.hex);
      expect(tiny.toHexString()).toBe(
        new TinyColor(tiny.toRgb()).toHexString(),
      );
    }
  });
  ...
  it('RGB String', () => {
    for (const c of conversions) {
      const tiny = new TinyColor(c.hex);
      expect(tiny.toHexString()).toBe(
        new TinyColor(tiny.toRgbString()).toHexString(),
      );
    }
  });
